<x-filament-panels::page>
    ...
    <flux:card class="space-y-8">
        ...
        {{-- PRELIMINARY --}}
        <x-table-judge-result heading="PRELIMINARY" :judges="$judges" :contest="$preliminaryContents" />

        {{-- FINAL --}}
        <x-table-judge-result heading="FINAL" :judges="$judges" :contest="$finalContents" />
